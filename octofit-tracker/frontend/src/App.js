    ...
    <Router>
      ...
      <div className="container">
        <Routes>
          ...
          <Route path="/" element={<div className="text-center mt-5"><h1 className="display-4">Bienvenido a <span className="text-primary">Octofit Tracker</span></h1><p className="lead">Tu plataforma para registrar actividades, equipos, usuarios y entrenamientos.</p></div>} />
        </Routes>
      </div>
    </Router>
  );
